...
\title{Environnement de simulation sous-marin}
\author{Quentin \textsc{Brateau} \\ \texttt{quentin.brateau@ensta-bretagne.orrg}}
\date{\today}
\doctype{Rapp0rot de PFE}
\promo{Version 0.1}
\etablissement{\textsc{Ensta} Bretagne\\2, rue Fran\c cois Verny\\
