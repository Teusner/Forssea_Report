...
\label{chapitre:systeme}
    ...
    \section{Spécifications fonctionnelles}
        ...
        \begin{figure}[!htb]
            ...
            %     \node[draw,minimum height=40pt, minimum width=100pt, fill=cyan!60!pink!70] (C0) at (0:5.5cm) {Robot};
            %     \node[draw,minimum height=40pt, minimum width=100pt, fill=cyan!60!pink!70] (C1) at (72:4cm) {Environnement};
            %     \node[draw,minimum height=40pt, minimum width=100pt, fill=cyan!60!pink!70] (C2) at (144:4cm) {Communication};
            %     \node[draw,minimum height=40pt, minimum width=100pt, fill=cyan!60!pink!70] (C3) at (216:4cm) {Interface};
            %     \node[draw,minimum height=40pt, minimum width=100pt, fill=cyan!60!pink!70] (C4) at (288:4cm) {Vizualisation};
            ...
            %     \draw[orange!80, line width=0.8mm] (C4) -- (S) node[midway, fill=white]{FC3};
            % \end{tikzpicture}
            \includegraphics[scale=0.8]{imgs/diagramme_pieuvre.pdf}
    ...
    \section{Spécifications techniques}
        ...
        \subsection{Ignition Libraries}
            ...
            \textit{Ignition Libraries}\footnote{\url{https://ignitionrobotics.org/libs}} est un ensemble de libraries permettant de faciliter le développement robotique. Deux libraries permettent de remplir la fonction contrainte \textbf{FC1} : \textit{Ignition-Transport} et \textit{Ignition-Msgs}. Elles permettent de faire communiquer deux parties de codes ensemble grâce à un système de messagerie basée sur l'utilisation de la bilbiothèque \textit{ProtocolBuffer} développée par \textit{Google}\footnote{\url{https://developers.google.com/protocol-buffers}}. C'est le même système de communication qui est utilisé par \gls{ROS2} et \gazebo{}. Il présente l'avantage de diviser le code en n\oe uds pouvant s'exécuter en parallèle et communicant ensemble par ces librairies, mais aussi de pouvoir récupérer l'état du simulateur par la lecture des messages transitants sur le réseau \textit{Ignition-Transport}.
