	...
	\section{Environnement marin}
		...
		\subsection{Modèle de houle trochoïdale}
			...
			\subsubsection{Modèle visuel de Gerstner}
				...
				Cependant, si ce modèle suffit à représenter la surface libre de la mer, il ne fournit pas la dynamique du milieu marin et l'impact qu'il va voir sur les \gls{ROV}s. C'est pourquoi il va falloir établir les équations de PRESSION et de VITESSE des particules afin de pouvoir simuler l'impact des vagues sur les robots.

			\subsubsection{Modèle dynamique du MIT}

				C'est à ce moment qu'intervient l'utilisation du modèle de vague du \textsc{MIT}~\cite{MIT_Waves}.
