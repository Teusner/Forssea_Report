	...
	\section{Environnement marin}
		...
		\subsection{Modèle de vagues}
			...
			\subsubsection{Modèle visuel de Gerstner}
				...
				\begin{figure}
					\centering
					\includegraphics{gerstner_pixar.pdf}
		...
		\subsection{Courants marins}
			...
			\subsubsection{Modèle constant}
				...
				\begin{figure}[!htb]
					\centering
					\input{build/imgs/courant_constant.pdf}
			...
			\subsubsection{Modèle procédural}
				...
				\begin{figure}[!htb]
					...
					\begin{subfigure}[b]{0.32\textwidth}
						\centering
						\includegraphics{noise_random.pdf}
						\caption{Bruit aléatoire}
					\end{subfigure}
					\hfill
					\begin{subfigure}[b]{0.32\textwidth}
						\centering
						\includegraphics{noise_perlin.pdf}
						\caption{Bruit de Perlin}
					\end{subfigure}
					\hfill
					\begin{subfigure}[b]{0.32\textwidth}
						\centering
						\includegraphics{noise_courant.pdf}
