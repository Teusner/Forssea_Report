	...
	\section{Environnement marin}
		...
		\subsection{Modèle de vagues}
			...
			\subsubsection{Modèle dynamique du MIT}
				...
				Comme pour le modèle de \textit{Gerstner}, chaque vague $m$ possède une amplitue $a_m$, un nombre d'onde $k_m$, une phase $\phi_m$ et une pulsation $\omega_m$. En notant $g$ l'accélération de pesanteur, et $H$ la hauteur de la colonne d'eau à l'endroit considéré, on a la relation de dispersion qui lie $\omega_m$ et $k_m$ :
