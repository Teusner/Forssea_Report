...
# Images
IMAGES_PDF = $(IMAGES_BUILD_DIR)/gerstner_wave.pdf $(IMAGES_BUILD_DIR)/gerstner_pixar.pdf $(IMAGES_BUILD_DIR)/courant_constant.pdf $(IMAGES_BUILD_DIR)/noise_courant.pdf $(IMAGES_BUILD_DIR)/noise_perlin.pdf $(IMAGES_BUILD_DIR)/noise_random.pdf $(IMAGES_BUILD_DIR)/rosace_local.pdf $(IMAGES_BUILD_DIR)/rosace_global.pdf $(IMAGES_BUILD_DIR)/gerstner_velocity_pressure_depth.pdf $(IMAGES_BUILD_DIR)/absolute_orientation_tracking.pdf
